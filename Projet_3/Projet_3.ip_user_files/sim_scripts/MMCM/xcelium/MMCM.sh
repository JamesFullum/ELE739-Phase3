...
#
# Script generated by Vivado on Wed Mar 20 15:11:19 -0400 2024
...
#
# Usage        : MMCM.sh
#                MMCM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MMCM.sh [-reset_run]
#                MMCM.sh [-reset_log]
#                MMCM.sh [-help]
#
...
#                script (type 'MMCM.sh -help' for more information).
#
...
# script info
echo -e "MMCM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MMCM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.MMCM xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.MMCM -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log MMCM_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: MMCM.sh [-reset_log]\n\
Usage: MMCM.sh [-keep_index]\n\
