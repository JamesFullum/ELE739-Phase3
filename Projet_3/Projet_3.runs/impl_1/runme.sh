...
HD_PWD='C:/Users/james/ETS/Hiver_2024/ELE739/ELE739-Projet_3/Projet_3/Projet_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DUT_Exp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DUT_Exp.tcl -notrace
