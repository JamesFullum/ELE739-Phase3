...
HD_PWD='C:/Users/james/ETS/Hiver_2024/ELE739/ELE739-Projet_3/Projet_3/Projet_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DUT_Exp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DUT_Exp.tcl
